    ...
    return (
        <React.Fragment>
            <Navbar color="red" light expand="md">
                <Link href="/">
                    <NavLink className="font-weight-bold" style={{ color: 'green' }} id="appname">
                        {APP_NAME}
                    </NavLink>
                </Link>
                ...
                <Collapse isOpen={isOpen} navbar>
                    <Nav className="ml-auto" navbar>
                        {isAuth() && (
                            <Link href="/cart">
                                <NavLink id="bakilacaklarlistem">
                                    <FaListUl className="mb-1 mr-1" />
                                    Bakılacaklar Listem
                                </NavLink>
                            </Link>
                        )}
                            ...
                            {isAuth() && isAuth().role === 1 && (
                                <NavItem>
                                    <Link href="/admin">
                                        ...
                                        <NavLink id="adminPanel" className="ml-2">
                                            {'Admin Panel'}
                                        </NavLink>
                                    </Link>
                                </NavItem>
