            ...
            <div className="row no-gutters">
                ...
                <div className="col-md-8">
                    <Link href={`/products/${product.slug}`}>
                        <a>
                            <h5 className="ml-3 mt-2" style={{ color: '#228B22' }}>
                                {product.title}
                            </h5>
                        </a>
                    </Link>
                    <h6 className="ml-3" style={{ color: 'green', fontSize: '25px', textAlign: 'left', float: 'left' }}>
                        {product.price}₺
                    </h6>
                    <h6
                        className="mr-3"
                        style={{ color: 'green', fontSize: '25px', textAlign: 'right', float: 'right' }}
                    >
                        {showAddToLaterLookAtBtn(showAddToLaterLookAtButton)}
                    </h6>
                    <h6
                        className="mr-3"
                        style={{ color: 'green', fontSize: '25px', textAlign: 'right', float: 'right' }}
