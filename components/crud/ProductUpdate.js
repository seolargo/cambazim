...
const ProductUpdate = ({router}) => {
    ...
    const editProduct = e => {
        ...
        updateProduct(formData, token, router.query.slug)
            .then(data => {
                if (data.error) {
        ...
        return (
            <form onSubmit={editProduct}>
                <div className="form-group">   
                    ...
                    <br/>
                    <label className="text-muted">
                        Kaç Adet Satıyorsunuz (Sadece Sayı Giriniz)
                    </label>
                    <input 
                        type="text" 
                        className="form-control" 
                    ...
                    <br/>
                    <label className="text-muted">
                        Hayvanın Fiyatı (Tekil Fiyat Giriniz)
                    </label>
                    <input 
                        type="text" 
                        className="form-control" 
                    ...
                    <br/>
                    <label className="text-muted">
                        Hayvanın Tahmini Kilosu (Tekil Hayvan İçin Giriniz)
                    </label>
                    <input 
                        type="text" 
                        className="form-control" 
                ...
                <div className="col-md-4">
                    <div>
                        <div className="form-group pb-2">
                            <h5 style={{color: 'green'}}>Resim Ekleyin/Değiştirin</h5>
                            <hr />
                            <p className="text-muted">Her bir resim için maksimum resim boyutu: 1MB <br/>(En az bir (zorunlu) en fazla altı resim yükleyebilirsiniz)</p>
                            <br/>
                            ...
                            <br/>
                            {body && <img src={`${API}/product/photo1/${router.query.slug}`} 
                                alt={title} 
                                style={{width: '50%'}}/>
                            }
                            <br />
                            ...
                            <br/>
                            {body && <img src={`${API}/product/photo2/${router.query.slug}`} 
                                alt={title} 
                                style={{width: '50%'}}/>
                            }
                            <br />
                            ...
                            <br/>
                            {body && <img src={`${API}/product/photo3/${router.query.slug}`} 
                                alt={title} 
                                style={{width: '50%'}}/>
                            }
                            <br />
                            ...
                            <hr/>
                            {body && <img src={`${API}/product/photo4/${router.query.slug}`} 
                                alt={title} 
                                style={{width: '50%'}}/>
                            }
                            <br />
                            ...
                            <br/>
                            {body && <img src={`${API}/product/photo5/${router.query.slug}`} 
                                alt={title} 
                                style={{width: '50%'}}/>
                            }
                            <br />
                            ...
                            <br/>
                            {body && <img src={`${API}/product/photo6/${router.query.slug}`} 
                                alt={title} 
                                style={{width: '50%'}}/>
                            }
                            <br />
