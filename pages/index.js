...
const Index = ({products, tags, totalProducts, productsLimit, productSkip, router}) => 
{
    ...
    const RadioBoxForVillages = ({selectedTown, villages, handleFilters}) => {
        ...
        return (
            villages.map((v, i) => ( v.tname === selectedTown ?
                <li key={i} className='list-unstyled'>
                    <input 
                        onChange={handleChange} 
                        value={`${v.Mahalle}`}
    ...
    useEffect(() => {
        ...
        console.log('myfilters.city: ', myFilters.filters.city)
        console.log('myfilters.town: ', myFilters.filters.town)
        console.log('myfilters.village: ', myFilters.filters.village)
        console.log('-------')*/
    }, [cityValue]);
    ...
    useEffect(() => {
        ...
        setTownValue(townValue);
        setVillageValue('');
        //setMyFilters({...myFilters}, myFilters.filters.town='')
        /*console.log('cityValue: ', cityValue)
        console.log('townValue:', townValue)
        console.log('myfilters.city: ', myFilters.filters.city)
        console.log('myfilters.town: ', myFilters.filters.town)
    ...
    useEffect(() => {
        ...
        //setMyFilters({...myFilters}, myFilters.filters.village='') 
        /*console.log('cityValue: ', cityValue)
        console.log('townValue:', townValue)
        console.log('myfilters.city: ', myFilters.filters.city)
        console.log('myfilters.town: ', myFilters.filters.town)
    ...
    return (
        <Layout>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-4"> 
                        <h4 style={{color: 'green'}}>Detaylı Arama</h4>
                        <hr />
                    ...
                    */}    
                    <div className="col-8">
                        <h2 className="mb-4" style={{textAlign: "center", color: "green"}}>İlanları Görüntülüyorsunuz</h2>
                        <div className="row">
