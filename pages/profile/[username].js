...
const UserProfile = ({ user, products, query }) => {
    const head = () => {
        <Head>
            ...
            <meta name="description" content={`${user.username}'in İlanları`} />
            ...
            {/* Open Graph will be used for Facebook. */}
            <meta property="og:description" content={`${user.username}'in İlanları`} />
            ...
            return (
                <div className="mt-4 mb-4" key={i}>
                    <Link href={`/products/${product.slug}`}>
                        <a className="lead" style={{ color: 'green' }}>
                            {product.title}
                        </a>
                    </Link>
                    <h6>
                        <br />
                        İlanın yayımlanma tarihi:{' '}
                        {moment(product.createdAt, 'YYYY-MM-DDThh-mm-ssZ').format('DD/MM/YYYY')}
                    </h6>
                    <h6>
                        Hayvanın Türü: {product.animalType}-{product.poultry}-{product.animalSubCategories}-
                                    ...
                                    <div className="row">
                                        <div className="col-md-8">
                                            ...
                                            <h6>
                                                ...
                                                {user.cellphone
                                                    ? user.cellphone
                                                    : 'Kullanıcı cep telefon numarasını belirtmemiş'}
                                            </h6>
