...
const Blogs = ({ blogs, categories, tags, totalBlogs, blogsLimit, blogSkip, router }) => {
    const head = () => {
        <Head>
            <title>Hayvan alıp-satmanın en kolay yolu | {APP_NAME}</title>
            <meta
                name="description"
            ...
            <meta property="og:title" content={`Latest web development tutorials on | ${APP_NAME}`} />{' '}
                    ...
                    <div className="container-fluid">
                        <header>
                            ...
                            <section id="categories-tags-list">
                                <div className="pb-2 text-center">{showAllCategories()}</div>
